...
public class App {
    ...
    public static void main(String[] args) {
        ...
        getFem(pessoas).forEach(p -> System.out.println(p.getNome() + "  -  "  + p.getSexo()));
        System.out.println("Lista de Homens Adicionadas: ");
        System.out.println("NOME   SEXO");
        getMas(pessoas).forEach(p -> System.out.println(p.getNome() + "  -  " + p.getSexo()));
    ...
    public static List<Pessoa> getMas(List<Pessoa> pessoas) {
    ...
    public static List<Pessoa> getFem(List<Pessoa> pessoas){
        return pessoas.stream()
